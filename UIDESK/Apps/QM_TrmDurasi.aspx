                                ...
                                <table class="table align-middle table-nowrap table-check" id="TableDurasi">
                                    <thead>
                                        <tr>
                                            ...
                                            <th style="width: 300px; min-width: 300px;">Durasi</th>
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body p-4">
                                    <div>
                                        ...
                                        <div class="mb-3">
                                            <label for="addcontact-name-input" class="form-label">Durasi</label>
                                            <input type="text" class="form-control" id="DurasiNya" placeholder="Durasi">
                                        </div>
                                    </div>
                                </div>
