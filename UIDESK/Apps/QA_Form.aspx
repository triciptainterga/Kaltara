...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
                    ...
                    <div class="text-end">
                        <div>
                            <div class="btn-group" role="group" aria-label="Button group with nested dropdown">
                                ...
                                <button type="button" class="btn btn-soft-primary w-sm" onclick="ButtonActionSimpan('Approved')"><i class="fa fa-save"></i>&nbsp;Calculate</button>
    ...
    <script>
        ...
        Ticket_Pertanyaan.config.height = 200;
        ...
        Ticket_Jawaban.config.height = 200;
        ...
        Ticket_TeamLeader.config.height = 200;
    ...
    <script>        
        ...
        Ticket_Deskripsi.config.height = 200;
