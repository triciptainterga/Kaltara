        ...
        success: function (data) {
            ...
            for (i = 0; i < json.length; i++) {
                ...
                ResultPenilaian = '<div class="col-xl-3 col-sm-6">' +
                    ...
                    '<a class="dropdown-item" href="QA_Form.aspx?qaid=' + json[i].KodeAlatTest + '&type=' + encodeData(json[i].NamaAlatTest) + '&UserType=' + json[i].KodeMasterForm + '&act=fu">Follow up</a> ' +
                    '</div> ' +
                    '</div> ' +
                    '</div> ' +
                    '</div> ' +
                    ...
                    '<span class="badge rounded-pill badge-soft-success font-size-12">' + json[i].KodeAlatTest + '</span>' +
                    '</div>' +
