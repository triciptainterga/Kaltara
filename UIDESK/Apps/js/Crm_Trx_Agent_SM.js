...
function LoadingUser() {
    $.ajax({
        ...
        data: "{TrxID:'Comment', TrxUserName: '" + $("#hd_sessionLogin").val() + "', TrxAction: 'UIDESK51'}",
                    ...
                    $.ajax(settings).done(function (response) {
                        ...
                        if (response.success == true) {
                            ...
                            var form_data = JSON.stringify({
                                ...
                                TrxCampaign: $("#ComboAccount").val(), TrxAccountName: $("#ComboAccount option:selected").text(), MaxCampaign: "0", sm_type: "1"
                            });
                            $.ajax({
