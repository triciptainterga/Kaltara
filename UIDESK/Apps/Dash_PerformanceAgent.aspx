                ...
                <div class="card-body">
                    <div class="d-flex justify-content-between">
                        <div>
                            ...
                            <h1 class="mt-4 font-weight-bold mb-2 d-flex align-items-center" style="color: #299FE1;">94,2
                            </h1>
                ...
                <div class="card-body">
                    <div class="d-flex justify-content-between">
                        <div>
                            ...
                            <h1 class="mt-4 font-weight-bold mb-2 d-flex align-items-center" style="color: #299FE1;">79,5
                            </h1>
                ...
                <div class="card-body">
                    <div class="d-flex justify-content-between">
                        <div>
                            ...
                            <h1 class="mt-4 font-weight-bold mb-2 d-flex align-items-center" style="color: #299FE1;">88,2
                            </h1>
                ...
                <div class="card-body">
                    <div class="d-flex justify-content-between">
                        <div>
                            ...
                            <h1 class="mt-4 font-weight-bold mb-2 d-flex align-items-center" style="color: #299FE1;">87,8
                            </h1>
                ...
                <div class="card-body">
                    <div class="">
                        <div>
                            ...
                            <h4 class="mt-4 font-weight-bold mb-2 d-flex align-items-center">31,53%</h4>
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="row align-items-center">
                                        <div class="col-sm-12">
                                            ...
                                            <p class="text-muted">
                                                <span class="text-success me-1">25.2%<i
                ...
                <div class="card-body">
                    <div class="">
                        <div>
                            ...
                            <h4 class="mt-4 font-weight-bold mb-2 d-flex align-items-center">34,50%
                            </h4>
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="row align-items-center">
                                        <div class="col-sm-12">
                                            ...
                                            <p class="text-muted">
                                                <span class="text-success me-1">15%<i
                                                    class="mdi mdi-arrow-up"></i></span>Dari target per hari
                                            </p>
                ...
                <div class="card-body">
                    <div class="">
                        <div>
                            ...
                            <h4 class="mt-4 font-weight-bold mb-2 d-flex align-items-center">31,16%
                            </h4>
                            <div class="card">
                                <div class="card-body">
                ...
                <div class="card-header">
                    ...
                    <div class="d-flex align-items-center">
                        ...
                        <div class="flex-grow-1">
                            ...
                            <h5 class="font-size-16 mb-0">109%</h5>
                        </div>
                        <div class="flex-shrink-0 align-self-end">
                            <div class="badge badge-soft-success ms-2">9 % <i class="uil uil-arrow-up-right text-success ms-1"></i></div>
                        </div>
                    </div>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row align-items-center">
                                        <div class="col-sm-12">
                                            <div class="row">
                                                <div class="col-lg-4">
                                                    <p class="text-muted mb-2">Handling
                                                        <br>
                                                        Time</p>
                                                    <h5>29:07:20</h5>
                                                </div>
                                                ...
                                                <div class="col-lg-4">
                                                    <p class="text-muted mb-2">Staffed
                                                        <br>
                                                        Time</p>
                                                    <h5>20:07:20</h5>
                                                </div>
                                    ...
                                    <div class="row align-items-center">
                                        <div class="col-sm-12">
                                            <div class="row">
                                                ...
                                                <div class="col-lg-4">
                                                    <p class="text-muted mb-2">Target
                                                        <br>
                                                        per Day</p>
                                                    <h5>20</h5>
                                                </div>
