                ...
                <div class="row">
                    ...
                    <div class="mail-list mt-4">
                        <a href="javascript:void(0)" class="active" onclick="OnclickInbox();" id="InboxClass">
                            ...
                            <span class="ms-1 float-end" style="text-align: center;">
                                <p id="InboxCount"></p>
                            </span>
                        </a>
                        <a href="javascript:void(0)" onclick="OnclickDraft()" id="FolderDraft"><i class="bx bx-file font-size-16 align-middle me-2"></i>Draft
                            <i class="bx bx-file font-size-16 align-middle me-2"></i>Draft
                            <span class="ms-1 float-end" style="text-align: center;">
                                <p id="DraftCount"></p>
                            </span>
                        </a>
                        <a href="javascript:void(0)" onclick="OnclickSendLeader()"><i class="bx bx-user-circle font-size-16 align-middle me-2"></i>Send To Leader
                            <i class="bx bx-user-circle font-size-16 align-middle me-2"></i>Send To Leader
                            <span class="ms-1 float-end" style="text-align: center;">
                                <p id="SentLeaderCount"></p>
                            </span>
                        </a>
                        <a href="javascript:void(0)" onclick="OnclickSendMail()" id="FolderSendEmail"><i class="bx bx-mail-send font-size-16 align-middle me-2"></i>Sent Mail
                            <i class="bx bx-mail-send font-size-16 align-middle me-2"></i>Sent Mail
                            <span class="ms-1 float-end" style="text-align: center;">
                                <p id="SentMailCount"></p>
                            </span>
                        </a>
                        <a href="javascript:void(0)" onclick="OnclickCase()" id="FolderCase"><i class="bx bx-briefcase-alt font-size-16 align-middle me-2"></i>Case
                        <a href="javascript:void(0)" onclick="OnclickCase()"><i class="bx bx-briefcase-alt font-size-16 align-middle me-2"></i>Case
                            <i class="bx bx-briefcase-alt font-size-16 align-middle me-2"></i>Case
                            <span class="ms-1 float-end" style="text-align: center;">
                                <p id="CaseCount"></p>
                            </span>
                        </a>
                            <a href="javascript:void(0)" onclick="OnclickArchieve()" id="FolderArchieve"><i class="bx bx-archive-in font-size-16 align-middle me-2"></i>Archieve
                            <i class="bx bx-archive-in font-size-16 align-middle me-2"></i>Archive
                            <span class="ms-1 float-end" style="text-align: center;">
                                <p id="ArchiveCount"></p>
                            </span>
                            </a>
