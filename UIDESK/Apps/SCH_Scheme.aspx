<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Apps/Uidesk.Master" CodeBehind="SCH_Scheme.aspx.vb" Inherits="UIDESK.SCH_Scheme" %>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="d-flex flex-wrap align-items-start justify-content-md-end mt-2 mt-md-0 gap-2 mb-3">
                            <div>
                                <i class="mdi mdi-information-outline"></i>Agent Scheme <a href="#" class="btn btn-light" data-bs-toggle="modal" onclick="Tambah()"><i class="far fa-calendar-plus"></i>Add Scheme</a>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="modal-body p-4">
                    ...
                    <div class="tab-content p-3 text-muted">
                        <div class="tab-pane active" id="shift1" role="tabpanel">
                            ...
                            <p>
                                Agent akan di assign kepada channel dan di jadwalkan pada tanggal yang dipilih! <i class="mdi mdi-information-outline"></i>
                            </p>
                                                                            Type Agent *
                            ...
                            <br />
                            <span style="display: inline-block;">Agent Terpilih: <div id="selectedCount" style="display: inline;">0</div></span>
                            <span style="display: inline-block; display:none;" id="maxChannel">Maximal: <div id="selectedMax" style="display: inline;"></div></span>
                            <br />
                            ...
                            <div class="row">
                                <div class="col-4">
                                    <p>
                                        ...
                                        <asp:HiddenField ID="hd_DateParamStart" ClientIDMode="Static" runat="server" />
                                    </p>
                                </div>

                                <div class="col-4 mb-4">
                                    <br />
                                    <button style="display:none" type="button" class="btn btn-primary w-sm" onclick="ActionGenerate()" id="btnGenerate">Generate</button>
                                </div>
                            </div>
                        ...
                        <div class="modal-footer">
                            ...
                            <button type="button" class="btn btn-primary w-sm" onclick="saveSchedule()" id="save-schedule">Add</button>
