                ...
                <div class="card-body">
                    ...
                    <dx:ASPxGridView ID="ASPxGridView1" ClientInstanceName="ASPxGridView1" DataSourceID="DSChannel" runat="server" Width="100%"
                        ...
                        <Columns>
                            ...
                            <dx:GridViewDataDateColumn Caption="Date" FieldName="DateLogin" Width="200px" PropertiesDateEdit-DisplayFormatString="yyyy-MM-dd hh:mm:ss"></dx:GridViewDataDateColumn>
                        </Columns>
                    </dx:ASPxGridView>
                    <hr />
                    <div class="row">
